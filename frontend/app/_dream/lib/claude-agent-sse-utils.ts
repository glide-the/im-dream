 ...
 * [Pos]    shared SSE helpers in frontend/app/_dream/lib
 ...
 *                      toolMetadata across reconnect replay.
 */
    ...
    case 'tool-output-available': {
      ...
      if (idx >= 0) {
        ...
        const baseTool = {
          ...
          input,
          title: prev.title,
          toolMetadata: event.isError || event.mcpAppResult === undefined
            ? prev.toolMetadata
            : {
                ...(prev.toolMetadata ?? {}),
                mcpAppResult: event.mcpAppResult,
              } as DynamicToolUIPart['toolMetadata'],
          providerExecuted: prev.providerExecuted,
