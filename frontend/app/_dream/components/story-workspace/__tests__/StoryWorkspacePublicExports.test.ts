...
// [Sync] 2026-09-05: resolve relocated Dream and Execution view-model exports from app/_dream/views.
...
import * as storyWorkspaceDreamViewModel from '../../../views/story-workspace/dreamViewModel';
import * as storyWorkspaceExecutionViewModel from '../../../views/story-workspace/executionViewModel';
