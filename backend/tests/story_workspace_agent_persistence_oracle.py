# [Input] Test-only legacy Story bundle DTO plus an in-memory SQL-compatible connection.
# [Output] Reproduce the retired Dream transaction for parity and rollback assertions only.
# [Pos] Historical persistence oracle under backend/tests; never imported by production code.
# [Sync] 2026-09-15: move retired Dream SQL out of the production Story parser.

"""Test-only oracle for the Story persistence behavior retired from Dream."""
