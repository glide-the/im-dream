...
# [Sync] 2026-09-13: advance the source contract to SDK 0.2.145 / local-core 0.1.8; deploy remains closed until a qualified package exists.
...
AUTODL_CLAUDE_RUNTIME_PACKAGE_ROOT="${AUTODL_CLAUDE_RUNTIME_PACKAGE_ROOT:-${AUTODL_CLAUDE_RUNTIME_REPOSITORY}/dist/core-package-linux-x64/ink-claude-code-dream-0.1.8}"
...
AutoDL Dream direct-host release:
  ...
  Claude pair:     ink-claude-dream-agent-sdk 0.2.145 + qualified Runtime 0.1.8 local-core (source 2.1.88; CLI compatibility 2.1.241)
...
jq -e '.runtime.version == \"0.1.8\" and .runtime.integration.sdkVersion == \"0.2.145\" and .core.corePruned == true and .core.productionEligible == true and .status.productionEligible == true and .core.sourceVersionEvidence == \"2.1.88\" and .core.cliCompatibilityVersion == \"2.1.241\" and .core.runtimeTarget == \"linux-x64\"' \"\${manifest}\" >/dev/null
...
runtime_package=\"\${prefix}/share/ink-claude-code-dream/releases/0.1.8-\${core_digest:0:16}\"
