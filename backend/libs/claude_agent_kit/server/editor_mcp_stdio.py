...
# [Output] Run the EditorEngine MCP namespace as a standalone stdio server for Claude Code CLI.
# [Pos] stdio-mcp-entrypoint node in libs/claude_agent_kit/server
# [Sync] 2026-05-23: initial implementation — EditorEngine live-state read tools over stdio.
...
async def main() -> None:
    """Start the EditorEngine MCP server on stdin/stdout."""
