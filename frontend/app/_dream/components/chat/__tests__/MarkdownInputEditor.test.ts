...
// [Pos] markdown-input-editor browser test node in frontend/app/_dream/components/chat/__tests__
...
test('converts user-authored rich text to Markdown and renders the submitted bubble faithfully', async ({ page }) => {
  const harnessModule = `
    ...
    import UserMessagePart from '/app/_dream/components/chat/UserMessagePart.tsx';
