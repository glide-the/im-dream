...
// [Pos] single source of truth for theme state in frontend/app/_dream/utils; all theme UI (Story Workspace sidebar toggle, settings segmented control) must read/write through this module.
...
//                    and fixed the "needs two clicks / stale icon" bug caused by multiple theme controls writing data-theme independently.
// [Sync] 2026-08-31: StoryWorkspaceSidebar and Settings remain the theme controls after the retired TopNavBar was removed.
