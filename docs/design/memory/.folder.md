...
<!-- [Sync] 2026-09-15: document Admin-owned Reflections custom config and Thread-before-filesystem ordering. -->
...
- 2026-09-15: current Reflections public configuration uses Admin OAuth operations; Dream retains static defaults, effective merge, file filtering and workspace writes.
