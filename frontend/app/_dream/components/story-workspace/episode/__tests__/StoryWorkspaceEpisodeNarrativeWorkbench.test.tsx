...
// [Sync] 2026-09-05: resolve Episode view-model imports and the browser harness from app/_dream/views.
...
} from '../../../../views/story-workspace/episodeExecutionViewModel';
import {
...
test('keeps real DOM focus stable across navigation, controlled transitions and Escape', async ({ page }) => {
  ...
  const harnessModule = `
    ...
    import { StoryWorkspaceEpisodeNarrativeWorkbench } from '/app/_dream/components/story-workspace/episode/StoryWorkspaceEpisodeNarrativeWorkbench.tsx';
    import { storyWorkspaceBuildEpisodeExecutionViewModel, storyWorkspaceEpisodeSelectionKey } from '/app/_dream/views/story-workspace/episodeExecutionViewModel.ts';
