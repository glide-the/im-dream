...
// [Pos] single source of truth for theme state in frontend/src/utils; all theme UI (Story Workspace sidebar toggle, settings segmented control) must read/write through this module.
