...
<!-- [同步] 2026-09-13：本页保持历史回执；已发布的当前 0.2.145 × 0.1.9 使用独立回执，不复用本页证据。 -->
...
当前 `develop` 源码合同。当前 SDK `0.2.145` × Runtime `0.1.9` 的同字节五包
发布与 fresh-install 证据见[新回执](runtime-0.1.9-release-and-local-dream-adoption.md)。
