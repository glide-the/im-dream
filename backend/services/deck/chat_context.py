...
[Sync] 2026-09-16: remove the unused SQL resolver; consume only Admin DTO snapshots.
...
- Admin returns one actor/Deck/Voice-bound strict DTO snapshot.
- This module validates ready/enabled facts and returns digest-pinned
