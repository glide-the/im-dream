...
// [Sync] 2026-09-05: consume the Episode execution view-model types from the non-framework app/_dream/views tree.
...
import type { StoryWorkspaceEpisodeShotNode } from '../../../views/story-workspace/episodeExecutionViewModel';
