...
// [Sync] 2026-09-06: own the canonical browser application beneath the private, non-route app/_dream tree.
...
// [Sync] 2026-09-05: use a framework-neutral public asset URL for the Next/Vite compatibility shell.
...
import { StoryWorkspaceSettingsPage } from './views/story-workspace';
...
export default function App() {
  ...
  }, [jumpToCellRequestNonce, writingRouteActive]);
  ...
  const loginBannerUrl = '/login-banner.jpg';
