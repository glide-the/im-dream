...
<!-- [Sync] 2026-09-16: document that Dream deployment entries receive no PostgreSQL credentials. -->
...
PostgreSQL, the shared schema, and all database access. Dream deployments call Admin APIs.
