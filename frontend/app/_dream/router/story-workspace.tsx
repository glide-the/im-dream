...
// [Sync] 2026-09-05: resolve route-level browser UI from app/_dream/views while root app/** remains the sole Next router.
...
} from '../views/story-workspace';
import {
  storyWorkspaceDreamReturnState,
  storyWorkspaceDreamShouldReturnToHistory,
} from '../views/story-workspace/storyWorkspaceDreamNavigation';
import {
