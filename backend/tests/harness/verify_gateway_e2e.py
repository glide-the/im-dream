...
# [Pos] Test-only named verification harness; not packaged as a Dream runtime entry point.
# [Sync] 2026-09-16: move SQL receipt inspection under backend/tests/harness; production Dream has no database module.
