...
const COMPONENT = read('app/_dream/components/Editor/WritingSuggestionCell.tsx');
const STYLES = read('app/_dream/components/Editor/WritingSuggestionCell.css');
const TEXT_HOOK = read('app/_dream/hooks/useTextCells.ts');
const WRITING_HOOK = read('app/_dream/hooks/useWritingSuggestions.ts');
const VOICE_API = read('app/_dream/api/voiceApi.ts');
const CHAT_WIDGET = read('app/_dream/components/ChatWidgetUI.tsx');
