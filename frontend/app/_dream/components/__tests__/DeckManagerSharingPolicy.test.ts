...
const COMPONENT = read('app/_dream/components/DeckManager.tsx');
const PANELS = read('app/_dream/components/deck/DeckManagerPanels.tsx');
const DETAILS = read('app/_dream/components/DeckEditorModal.tsx');
const DETAILS_STYLES = read('app/_dream/components/DeckEditorModal.css');
const VERSION_PANEL = read('app/_dream/components/deck/DeckVersionPanel.tsx');
const VERSION_DIALOG = read('app/_dream/components/deck/DeckVersionSubmitDialog.tsx');
const VERSION_API = read('app/_dream/api/deckVersionApi.ts');
const VERSION_HOOK = read('app/_dream/hooks/useDeckContentVersions.ts');
const PLUGIN_API = read('app/_dream/api/deckPluginApi.ts');
const API = read('app/_dream/api/voiceApi.ts');
const CHAT_API = read('app/_dream/api/chatHistoryApi.ts');
const CHAT_VIEW = read('app/_dream/components/chat/ChatView.tsx');
const CHAT_INPUT = read('app/_dream/components/chat/AIInputDock.tsx');
const I18N = read('app/_dream/i18n.ts');
const STYLES = read('app/_dream/components/deck/DeckManagerPanels.css');
const CONSTANTS = read('app/_dream/constants/deck.ts');
const APP = read('app/_dream/App.tsx');
const SETTINGS = read('app/_dream/views/story-workspace/StoryWorkspaceSettingsPage.tsx');
const PATHS = read('app/_dream/router/storyWorkspacePath.ts');
